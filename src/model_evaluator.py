...
"""
This file is required to evaluate different models seperately 
as different type of data requires different types of evaluation 
so we can easily switch the evaluation strategy and extend the code.
